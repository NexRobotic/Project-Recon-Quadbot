...
void setup() {
  Serial.begin(9600);
  neck.attach(10);  // Attach servo to pin 9
  neck.write(90);  // Start at 90 degrees
...
void RC_Control() {
  ...
  channelValues[4] = (pulseWidths[4] > 1500) ? 1 : (pulseWidths[4] < 1100) ? -1
                                                                           : 0;  //to control movement speed
